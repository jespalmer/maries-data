...
report <- function(file, month1 = "01", month2 = "01", year1 = "16", year2 = "15") {
    ...
    # save as pdf
    pdf(paste("oct_summary_byproduct", ".pdf", sep = ""), useDingbats = FALSE)
    print(s)
    dev.off()
    ...
    # save as pdf
    pdf(paste("oct_summary_totals", ".pdf", sep = ""), useDingbats = FALSE)
    print(g)
    dev.off()
    ...
    product.graph <- function(long, ...) {
        ...
        for (i in seq_along(product_list)) {
            ...
            plot <- ggplot(subset(long, long$product == product_list[i]), aes(x = year,
                ...
                ggtitle(paste("October ", product_list[i], " sales in 2015 and 2016",
    ...
    # save as pdf
    pdf(paste("oct_summary_bestproducts", ".pdf", sep = ""), useDingbats = FALSE)
    print(g)
    dev.off()
    ...
    g <- g + theme(plot.title = element_text(color = "black", face = "bold", size = 12,
        ...
        strip.text.x = element_text(size = 3))
    # save as pdf
    pdf(paste("oct_summary_worstproducts", ".pdf", sep = ""), useDingbats = FALSE)
    print(g)
    dev.off()
    ...
    t <- t + theme(plot.title = element_text(color = "black", face = "bold", size = 12,
        ...
        strip.text.x = element_text(size = 3))
    # save as pdf
    pdf(paste("oct_summary_beststores", ".pdf", sep = ""), useDingbats = FALSE)
    print(t)
    dev.off()
    ...
    t <- t + theme(plot.title = element_text(color = "black", face = "bold", size = 12,
        ...
        strip.text.x = element_text(size = 3))
    # save as pdf
    pdf(paste("oct_summary_worststores", ".pdf", sep = ""), useDingbats = FALSE)
    print(t)
    dev.off()
    ...
    y <- y + theme(plot.title = element_text(color = "black", face = "bold", size = 12,
        ...
        strip.text.x = element_text(size = 3))
    # save as pdf
    pdf(paste("oct_summary_profitstores", ".pdf", sep = ""), useDingbats = FALSE)
    print(y)
    dev.off()
}
