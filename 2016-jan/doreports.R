...
header("2016 Monthly Wholesale Summary ran on Feb 2, 2016")

#year summary
# header("2016 Gross Wholesale Totals | All Quarters")
# report("fixed_orders.csv")
# #year top products as percentage of YTD
# header("2016 Wholesale Totals | All Quarters | Bestselling Products")
# report("fixed_orders.csv", product="best", store="skip")
# #year top stores as percentage of YTD
# header("2016 Wholesale Totals | All Quarters | Bestselling Stores")
# report("fixed_orders.csv", product="skip", store="best")
# #year bottom products as percentage of YTD
# header("2016 Wholesale Totals | All Quarters | Worstselling Products")
# report("fixed_orders.csv", product="worst", store="skip")
# #year bottom stores as percentage of YTD
# header("2016 Wholesale Totals | All Quarters | Worstselling Stores")
