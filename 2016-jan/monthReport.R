...
report <- function(file, month1= "01", month2= "01", year1="16", year2="15") {
  ...
  #save as pdf
  pdf(paste("january_summary_beststores", ".pdf", sep=""), useDingbats=FALSE)
  print(t)
  dev.off()
  ...
  #save as pdf
  pdf(paste("january_summary_worststores", ".pdf", sep=""), useDingbats=FALSE)
  print(t)
  dev.off()
  ...
  #save as pdf
  pdf(paste("january_summary_profitstores", ".pdf", sep=""), useDingbats=FALSE)
  print(y)
  dev.off()
}
